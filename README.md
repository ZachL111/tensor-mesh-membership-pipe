...
tensor-mesh-membership-pipe is a SQL project for distributed systems. It focuses on this technical goal: Implement an SQL distributed systems project for membership constraint solving, using bounded scenario files and conflict explanations.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 158, risk penalty 7, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
