"""Regression checks for the tensor-mesh-membership-pipe casebook."""
...
from casebook.harness import assert_expected, tensor_mesh_membership_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_mesh_membership_pipe_summary(), assert_expected())
