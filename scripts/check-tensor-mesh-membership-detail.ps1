...
$repo = "tensor-mesh-membership-pipe"
$language = "SQL"
$category = "Distributed systems"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/tensor-mesh-membership-walkthrough.md")) {
